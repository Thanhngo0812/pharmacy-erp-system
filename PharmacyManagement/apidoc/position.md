    ...
    "data": [
        {
            ...
            "approvalReason": "Khởi tạo hệ thống",
            "proposedById": 1,
...
## 3. Search Positions (Management View)
Searches for positions by name (partial match) and/or status.

- **URL**: `/api/positions/search`
- **Method**: `GET`
- **Query Parameters**:
  - `keyword` (Optional): String to search in the position's name.
...
{
    "success": true,
    "message": "Positions searched successfully",
    "data": [
        {
            "id": 2,
            "positionName": "Thực tập sinh",
...
{
    "status": "Approved", 
    "approvalReason": "Đồng ý mở rộng team Marketing"
}
```
